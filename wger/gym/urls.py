...
from wger.gym.views import (gym, config, admin_config, user_config,
...
patterns_gym = [
    ...
    url(r'^(?P<gym_pk>\d+)/add-member$',
        ...
        name='add-user'),
    url(r'^add$', gym.GymAddView.as_view(), name='add'),
    url(r'^(?P<pk>\d+)/edit$', gym.GymUpdateView.as_view(), name='edit'),
    url(r'^(?P<pk>\d+)/delete$', gym.GymDeleteView.as_view(), name='delete'),
...
patterns_admin_notes = [
    ...
    url(r'^add/user/(?P<user_pk>\d+)$',
        ...
        name='add'),
    url(r'^(?P<pk>\d+)/edit$', admin_notes.UpdateView.as_view(), name='edit'),
    url(r'^(?P<pk>\d+)/delete$',
...
patterns_documents = [
    url(r'^list/user/(?P<user_pk>\d+)$',
        ...
        name='list'),
    url(r'^add/user/(?P<user_pk>\d+)$', document.AddView.as_view(),
        name='add'),
    url(r'^(?P<pk>\d+)/edit$', document.UpdateView.as_view(), name='edit'),
    url(r'^(?P<pk>\d+)/delete$', document.DeleteView.as_view(), name='delete'),
]

# sub patterns for contracts
patterns_contracts = [
    url(r'^add/(?P<user_pk>\d+)$', contract.AddView.as_view(), name='add'),
    url(r'^view/(?P<pk>\d+)$', contract.DetailView.as_view(), name='view'),
    url(r'^edit/(?P<pk>\d+)$', contract.UpdateView.as_view(), name='edit'),
    url(r'^list/(?P<user_pk>\d+)$', contract.ListView.as_view(), name='list'),
]

# sub patterns for contract types
patterns_contract_types = [
    url(r'^add/(?P<gym_pk>\d+)$', contract_type.AddView.as_view(), name='add'),
    url(r'^edit/(?P<pk>\d+)$', contract_type.UpdateView.as_view(),
        name='edit'),
    url(r'^delete/(?P<pk>\d+)$',
...
patterns_export = [
    url(r'^users/(?P<gym_pk>\d+)$', export.users, name='users'),
]
...
urlpatterns = [
    ...
    url(r'^admin-config/',
        include(patterns_adminconfig, namespace="admin_config")),
    url(r'^user-config/', include(
        patterns_userconfig, namespace="user_config")),
    ...
    url(r'^contract-type/',
        include(patterns_contract_types, namespace="contract_type")),
